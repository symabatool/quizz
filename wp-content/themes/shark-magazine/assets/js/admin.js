jQuery(document).ready(function($) {
    ...
    $( document ).on( 'click', '.widget_multi_add_field', shark_magazine_widget_multi_add_field )
        .on( 'change', '.widget_multi_single_field', shark_magazine_widget_multi_single_field )
        .on( 'click', '.widget_multi_remove_field', shark_magazine_widget_multi_remove_field )

    function shark_magazine_set_multi_add_field() {
    ...
    shark_magazine_set_multi_add_field();
    
    function shark_magazine_widget_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            shark_magazine_widget_multi_write( $control );
    }

    function shark_magazine_widget_multi_single_field() {
        var $control = $( this ).parents( '.widget_multi_input' );
        shark_magazine_widget_multi_write( $control );
    }

    function shark_magazine_widget_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.widget_multi_input' );
        $this.parent().remove();
    ...
    function shark_magazine_widget_multi_write( $element) {
    ...
    $(document).on("click", ".shark-magazine-accordion", function (e) {
        e.preventDefault();
        var $button = $(this);

        $button.next('.shark-magazine-panel').slideToggle();
    ...
    function shark_magazine_contentTypeChange() {
    ...
    shark_magazine_contentTypeChange();

    function shark_magazine_widget_chosen() {
        $(".shark-magazine-widget-chosen-select").chosen({
            width: "100%"
        });
    }
    shark_magazine_widget_chosen();
