...
jQuery( document ).ready(function($) {
    ...
    $(".shark-magazine-chosen-select").chosen({
        width: "100%"
    });
    ...
    $( document ).on( 'click', '.customize_multi_add_field', shark_magazine_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', shark_magazine_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', shark_magazine_customize_multi_remove_field )
    ...
    function shark_magazine_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            shark_magazine_customize_multi_write( $control );
    }

    function shark_magazine_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        shark_magazine_customize_multi_write( $control );
    }

    function shark_magazine_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function shark_magazine_customize_multi_write( $element) {
