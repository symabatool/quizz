...
class Shark_Magazine_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'shark_magazine';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'shark-magazine' ), $i ),
...
// Initialize.
$shark_magazine_footer_widgets = new Shark_Magazine_Footer_Widgets();
