 ...
 */
Class Shark_Magazine_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Shark_Magazine_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Shark_Magazine_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="shark-magazine-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @see WP_Customize_Control
 */
class Shark_Magazine_Dropdown_Multiple_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="shark-magazine-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 * @see WP_Customize_Control
 */
Class Shark_Magazine_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @access public
 */
class Shark_Magazine_Customize_Section_Upsell extends WP_Customize_Section {
